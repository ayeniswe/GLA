from lxml.etree import Element, fromstring, iterparse

from gla.analyzer.iterator import Mode
from gla.plugins.transformer.xml_transformer import JLU, XMLTransformer
from gla.plugins.transformer.xmlfragment_transformer import (
    WinEvent,
...
def test_xml_fragment_transformer_passed_validation(get_log_path):
    ...
    # ACT
    result = transformer.validate({"data": valid_file, "encoding": "utf-16"})
...
def test_xml_fragment_transformer_failed_validation(get_log_path):
    ...
    # ACT
    result = transformer.validate({"data": invalid_file, "encoding": "utf-8"})
...
def test_xml_transformer_passed_validation(get_log_path):
    ...
    # ACT
    result = transformer.validate({"data": valid_file, "encoding": "utf-8"})
