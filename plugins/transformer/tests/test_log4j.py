...
def test_log4j_transformation():
    ...
    test_cases = [
        {
            "input": "2020-02-01 [worker-thread] WARN database.connection - Failed to connect to database",
        ...
        {
            "input": "2020-01-02 [network-thread] INFO network.service - Server started successfully",
